...
> [!NOTE]
> Project Shattered is in **very** _early_ development, features will be experimental and may be removed.\
> Some features may also not be implemented due to Curseforge's limited API system.\
> A useable alpha release is expected to be available in Middle - Late 2025.
...
Project Shattered is licenced under the MIT Licence, Copyright (c) 2024 **_LieOn Studios_** - see the full [LICENCE](https://github.com/LieOnStudios/project-shattered/blob/windows/LICENSE)
