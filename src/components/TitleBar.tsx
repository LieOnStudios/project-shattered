...
const TitleBar = () => {
    ...
    return (
        <header data-tauri-drag-region className='inline-flex w-full h-12 items-center justify-between border-b-2 border-grey-300'>
            ...
            <div className='font-medium text-xs text-grey-800'>v{APP_VERSION} - {BUILD_TYPE} build</div>
